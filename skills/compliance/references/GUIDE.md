...
This guide provides comprehensive documentation for the **compliance** skill in the custom-plugin-css plugin.
...
```bash
# Invoke the skill
claude "compliance - [your task description]"

# Example
claude "compliance - analyze the current implementation"
```
...
def implement_compliance(input_data):
    """
    Implement compliance functionality.
