...
This guide provides comprehensive documentation for the **css-tailwind** skill in the custom-plugin-css plugin.
...
```bash
# Invoke the skill
claude "css-tailwind - [your task description]"

# Example
claude "css-tailwind - analyze the current implementation"
```
...
def implement_css_tailwind(input_data):
    """
    Implement css-tailwind functionality.
