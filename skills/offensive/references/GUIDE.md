...
This guide provides comprehensive documentation for the **offensive** skill in the custom-plugin-css plugin.
...
```bash
# Invoke the skill
claude "offensive - [your task description]"

# Example
claude "offensive - analyze the current implementation"
```
...
def implement_offensive(input_data):
    """
    Implement offensive functionality.
