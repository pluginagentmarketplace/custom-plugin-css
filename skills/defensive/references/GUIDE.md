...
This guide provides comprehensive documentation for the **defensive** skill in the custom-plugin-css plugin.
...
```bash
# Invoke the skill
claude "defensive - [your task description]"

# Example
claude "defensive - analyze the current implementation"
```
...
def implement_defensive(input_data):
    """
    Implement defensive functionality.
