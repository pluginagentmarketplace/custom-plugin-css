...
This guide provides comprehensive documentation for the **css-animations** skill in the custom-plugin-css plugin.
...
```bash
# Invoke the skill
claude "css-animations - [your task description]"

# Example
claude "css-animations - analyze the current implementation"
```
...
def implement_css_animations(input_data):
    """
    Implement css-animations functionality.
