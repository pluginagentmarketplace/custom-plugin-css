...
This guide provides comprehensive documentation for the **css-modern** skill in the custom-plugin-css plugin.
...
```bash
# Invoke the skill
claude "css-modern - [your task description]"

# Example
claude "css-modern - analyze the current implementation"
```
...
def implement_css_modern(input_data):
    """
    Implement css-modern functionality.
