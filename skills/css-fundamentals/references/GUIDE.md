...
This guide provides comprehensive documentation for the **css-fundamentals** skill in the custom-plugin-css plugin.
...
```bash
# Invoke the skill
claude "css-fundamentals - [your task description]"

# Example
claude "css-fundamentals - analyze the current implementation"
```
...
def implement_css_fundamentals(input_data):
    """
    Implement css-fundamentals functionality.
