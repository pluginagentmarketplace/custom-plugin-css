...
This guide provides comprehensive documentation for the **forensics** skill in the custom-plugin-css plugin.
...
```bash
# Invoke the skill
claude "forensics - [your task description]"

# Example
claude "forensics - analyze the current implementation"
```
...
def implement_forensics(input_data):
    """
    Implement forensics functionality.
